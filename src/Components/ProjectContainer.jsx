...
const ProjectContainer = () => {
  const projects = [
    {
      ...
      description: 'BCA Notes for BCA students in Nepal, ensuring top-quality study materials and academic resources for success in the BCA program.',
  ...
  return (
    <section className="mt-8">
      <h2 className="text-lg mx-3 text-white font-bold mb-4">Project Showroom</h2>
