...
const Hire = () => {
  ...
  return (
    <div className="h-screen flex items-center justify-center" style={pageStyle}>
      <div className="text-white text-center">
        <h1 className="text-2xl md:text-5xl lg:text-5xl font-bold mb-4">
          Hire Me
        </h1>
        <div className="bg-gray-100 h-0.5 w-20 mx-auto mb-4"></div>
        <p className="text-lg md:text-2sm lg:text-4sm mb-6">
