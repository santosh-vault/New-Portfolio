...
const About = () => {
  return (
    <div className="bg-gray-900 min-h-screen flex flex-col items-center justify-center py-8 sm:py-16 px-2 sm:px-4">
      <div className="relative overflow-hidden w-full max-w-xs sm:max-w-2xl lg:max-w-3xl mx-auto">
        <div className="glow absolute top-0 left-0 w-full h-full rounded-md"></div>
        <Navbar />
        <div className="mb-8 text-center text-white">
          <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight my-4">
            About Me
          </h1>
          <div className="bg-purple-500 h-1 w-20 mx-auto mb-4"></div>
        </div>
        <div className="bg-purple-800 text-white p-4 sm:p-8 md:p-12 lg:p-16 rounded-md relative z-10">
          <div className="text-sm sm:text-base lg:text-lg leading-relaxed mb-4 sm:mb-6">
          ...
          <div className="text-sm sm:text-base lg:text-lg leading-relaxed mb-4 sm:mb-6 italic text-gray-300 w-full sm:w-4/5 mx-auto">
